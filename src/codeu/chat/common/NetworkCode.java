...
public final class NetworkCode {
  ...
  public static final int
      ...
      GET_CONVERSATION_INTERESTS_REQUEST = 33,
      GET_CONVERSATION_INTERESTS_RESPONSE = 34,
      NEW_CONVERSATION_INTEREST_REQUEST = 35,
      NEW_CONVERSATION_INTEREST_RESPONSE = 36,
      GET_USER_INTERESTS_REQUEST = 37,
      GET_USER_INTERESTS_RESPONSE = 38,
      NEW_USER_INTEREST_REQUEST = 39,
      NEW_USER_INTEREST_RESPONSE = 40,
      REMOVE_USER_INTEREST_REQUEST = 41,
      REMOVE_USER_INTEREST_RESPONSE = 42,
      REMOVE_CONVERSATION_INTEREST_REQUEST = 43,
      REMOVE_CONVERSATION_INTEREST_RESPONSE = 44,
      NEW_UPDATED_CONVERSATION_REQUEST = 45,
      NEW_UPDATED_CONVERSATION_RESPONSE = 46,
      REMOVE_UPDATED_CONVERSATION_REQUEST = 47,
      REMOVE_UPDATED_CONVERSATION_RESPONSE = 48,
      GET_UPDATED_CONVERSATIONS_REQUEST = 49,
      GET_UPDATED_CONVERSATIONS_RESPONSE = 50;
}
